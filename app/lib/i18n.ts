  ...
  tr: {
    ...
    about: {
      ...
      projects: [
        ...
        'Bulmaca Ustası — Mobil bulmaca (kapalı test)',
        'Emojice — Mobil oyun (erken test)',
        'Builder Platform — Çok kiracılı site builder iç aracı (geliştirme)',
  ...
  en: {
    ...
    about: {
      ...
      projects: [
        ...
        'Bulmaca Ustası — Mobile puzzle (closed test)',
        'Emojice — Mobile game (early test)',
        'Builder Platform — Multi-tenant site builder internal tool (in development)',
